...
cov_vars <- c("log_build_flat", "catering_c_pc", "construction_c_pc",
...
mod_sa1 = feols(t8013002_1_c_pc ~ sunab(first.treat, year) + 
                 log_build_flat + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
                 settlement + year,  
...
mod_sa2 = feols(t8013002_231_c_pc ~ sunab(first.treat, year) + 
                 log_build_flat + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
...
mod_sa3 = feols(t8013002_212_c_pc ~ sunab(first.treat, year) + 
                 log_build_flat + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
...
mod_sa4 = feols(t8013002_229_c_pc ~ sunab(first.treat, year) + 
                 log_build_flat + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
...
mod_sa5 = feols(t8013002_234_c_pc ~ sunab(first.treat, year) + 
                 log_build_flat + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
               ...
               cluster = ~region,  
               data = data)
summary(mod_sa5, agg = "att")



mods <- list(summary(mod_sa1, agg = "att"),
             summary(mod_sa2, agg = "att"),
             summary(mod_sa3, agg = "att"), 
             summary(mod_sa4, agg = "att"), 
             summary(mod_sa5, agg = "att"))

mods %>% etable(style.tex = style.tex("aer"), 
                fitstat = ~ r2 + n, tex = T)

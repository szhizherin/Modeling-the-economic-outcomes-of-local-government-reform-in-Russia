...
# профицит бюджета на душу с минимальным набором контролей | competitive
...
mod_twfe = feols(budget_prof_c_pc ~ i(time_to_treat*(1-competitive), treat, ref = -1) + treatment +
                   log_build_flat + log_new_housing + catering_c_pc + construction_c_pc +
                   retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                   living_space + n_companies + pop_work + log_population + log_wage +
                   workers + t8006003 + pension_c | 
...
mod_twfe_total = feols(budget_prof_c_pc ~ i(treatment, competitive, 1) + treatment + 
                         log_build_flat + log_new_housing + catering_c_pc + construction_c_pc +
                         retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                         living_space + n_companies + pop_work + log_population + log_wage +
                         workers + t8006003 + pension_c |                   
...
mod_sa = feols(budget_prof_c_pc ~ sunab(first.treat*(1-competitive), year) + treatment +
                 log_build_flat + log_new_housing + catering_c_pc + construction_c_pc +
                 retail_c_pc + volume_electr_c_pc + volume_manufact_c_pc + doctors_per10 +
                 living_space + n_companies + pop_work + log_population + log_wage +
                 workers + t8006003 + pension_c | 
...
# профицит бюджета на душу без контролей | competitive
y_var <- "budget_prof_c_pc"
cov_vars <- c()
